		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				...
				<form action="" method="post">
					...
					<input   class="text" type="password" name="password" placeholder="New Password" id="password" required><br>
						<input   class="text" type="password" name="password2" placeholder="Confirm Password" id="password2" required><br>

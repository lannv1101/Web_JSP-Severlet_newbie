...
public class PageInfo {
	...
	static {
		...
		pageRoute.put(PageType.SITE_HOME_PAGE, new PageInfo("Home Page","/sites/home/home2.jsp", null));
		...
		pageRoute.put(PageType.SITE_VIDEO_DETAIL_PAGE, new PageInfo("Video Detail","/sites/users/detail.jsp", null));
		pageRoute.put(PageType.SITE_SHARE_PAGE, new PageInfo("Shares","/sites/users/share.jsp", null));
	...
	public static void prepareAndForwardSite(HttpServletRequest request,HttpServletResponse response, PageType pageType) throws ServletException, IOException  {
		...
		request.getRequestDispatcher("/sites/layout2.jsp").forward(request, response);
	}

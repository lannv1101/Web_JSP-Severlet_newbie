		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				...
				<form action="" method="post">
					...
					<input   class="text" type="password" name="password" placeholder="Last Password" id="password" required><br>
						<input   class="text" type="password" name="password2" placeholder="New Password" id="password2" required><br>

			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="input-group form-group">
							...
							<input name="receiver" type="text" class="form-control" placeholder="Friends@gmail.com">
						...
						<div class="input-group form-group">
							...
							<textarea name="message" rows="4" cols="3" class="form-control">
						...
						<div class="form-group">
							<input type="submit" value="Send"
								...
								<a href="Homepage" class="btn float-left login_btn">Back</a>

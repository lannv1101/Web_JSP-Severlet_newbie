		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				...
				<form action="#" method="post">
					<input value="${user.username }" class="text" type="text" name="username" placeholder="Username" id="username" required><br>
					<input  value="${user.fullname }" class="text" type="text" name="fullname" placeholder="Fullname" id="fullname" required><br>
					<input   class="text" type="password" name="password" placeholder="Password" id="password" required><br>
					<input  value="${user.email }" class="text" type="text" name="email" placeholder="Email" id="email" required><br>
